...
private _colourIndex = lbValue[1501,(lbCurSel 1501)];
...
[format["You bought a %1 for $%2.",getText(configFile >> "CfgVehicles" >> _className >> "displayName"),str(_price)],"green"] call DT_fnc_notify;

...
["Reviving",7.692,"AinvPknlMstpSnonWnonDnon_medic4","isNull objectParent player && ([MB_Interaction_Target] call DT_fnc_checkPlayer)",
{
	...
	if (MB_Interaction_Target getVariable ["blood",0] isEqualTo 0 || {(MB_Interaction_Target getVariable ["injuries",[]] select 0) isEqualTo 1}) exitWith {["Defibrillation failed.","orange"] call DT_fnc_notify};

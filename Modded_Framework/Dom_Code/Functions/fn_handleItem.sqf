...
call {
	...
	if (_item isEqualTo "D_Battery_i") exitWith {phone_battery = (phone_battery + 50) min 100; ["You successfully charged your phone.","green"] call DT_fnc_notify; player removeItem _item; closeDialog 0};

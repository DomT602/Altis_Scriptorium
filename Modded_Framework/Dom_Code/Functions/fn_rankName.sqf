...
if (_faction isEqualTo "medic") exitWith {
	private _ranks = call {
		if (_department isEqualTo 0) exitWith {["Probationary EMT","EMT","Senior EMT","Paramedic","Lieutenant","Captain","Chief"]};
		if (_department isEqualTo 1) exitWith {["Probationary Trooper","Trooper","Senior Trooper","Paramedic","Lieutenant","Captain","Chief"]};

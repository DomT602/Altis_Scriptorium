...
if (count(_house getVariable ["furniture",[]]) >= (getNumber(missionConfigFile >> "Buildings" >> "Houses" >> (typeOf _building) >> "maxFurniture"))) exitWith {["You can't fit any more furniture in this building.","orange"] call DT_fnc_notify};

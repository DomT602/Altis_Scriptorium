...
/*
	...
	To-do: Place files in desired location, default (core/functions), add to functions.hpp, add following to fn_setupEVH.sqf:
		addMissionEventHandler ["Draw3D",{_this call life_fnc_playerTags}];
	Populate donator colours fully, chance cop/medic icons, ranks and colours if needed
*/

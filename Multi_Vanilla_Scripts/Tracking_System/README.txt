This folder contains the scripts needed for the full tracking system. This allows you to put GPS Trackers on players and vehicles, track them via the map (only when open for performance), and remove them (planned).

...
holstered for a time, longer if you have a seatbelt on.

Setup:
Download files from github
Put fn_onGetOutMan.sqf and fn_seatbelt.sqf into core/functions
...
Scroll wheel (add an action into fn_setupActions.sqf):
...
Keybind (add a case into fn_keyHandler.sqf): 
case 54:
